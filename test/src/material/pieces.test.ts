...
describe('compute piece', () => {
    ...
    describe('droste mode', () => {
        ...
        describe('with 3 layers', () => {
            ...
            describe('value', () => {
                it('the value decreases quadratically from 1 to 1/sieve', () => {
            ...
            describe('intensity', () => {
                it('the intensity on the even elements (layer 1 of 3) decreases from 1 to almost 0', () => {
                    const evenIntensities: number[] = evenElements(piece)
                        .map((element: ContourElement<PitchValueIntensityEnvelopeScale>) => use.Ordinal(element, INDEX_OF_GAIN_IN_CONTOUR))

                    expect(evenIntensities)
                        .toGoMonotonicallyFromValueToValue(1, 0, VERY_LOW_PRECISION)
                })

                it('the intensity on the even elements of the odd elements (layer 2 of 3) increases from almost 0 to almost 1 - crossing the evens in the middle at 0.5', () => {
                ...
                it('the intensity on all the other elements (layer 3 of 3, AKA the non-layer) is set at 0', () => {
            ...
            describe('pitch index', () => {
                it('wraps around the kernel over and over', () => {
                    forEach(
                        piece,
                        ([ pitchIndex, value, intensity, sustain, pitchScalar ]: ContourElement<PitchValueIntensityEnvelopeScale>, index: Ordinal<ContourPiece<PitchValueIntensityEnvelopeScale>>) => {
                            expect(pitchIndex)
            ...
            describe('pitch scalar, with stretch pitch true', () => {
                it('the pitch on the even elements (layer 1 of 3) is scaled, by a factor increasing quadratically from 1 to sieve, because the first layer is the highest pitch, fastest one, about to fade out', () => {
                    const evenPitchScalars: number[] = evenElements(piece)
                        .map((element: ContourElement<PitchValueIntensityEnvelopeScale>) => use.Ordinal(element, INDEX_OF_PITCH_SCALAR_IN_CONTOUR))
                ...
                it('the pitch on all other elements (odds of the odds, layer 3 of 3 AKA the non-layer) are at 2, the max, though it does not really matter because their intensities are at zero, but we think of this as like their resting place after having climbed this high I guess', () => {
            ...
            describe('sustain', () => {
                it('is the reciprocal of the sieve', () => {
                    const sustains: number[] = piece.map(
                        (element: ContourElement<PitchValueIntensityEnvelopeScale>) => use.Ordinal(element, INDEX_OF_ENVELOPE_IN_CONTOUR),
                    )
        ...
        describe('with 4 layers', () => {
            ...
            describe('value', () => {
                it('the value decreases quadratically from 1 to 1/sieve, just as it does in layer count 2', () => {
                    const values: number[] = piece.map(
                        (element: ContourElement<PitchValueIntensityEnvelopeScale>) => use.Ordinal(element, INDEX_OF_DURATION_IN_CONTOUR),
                    )
            ...
            describe('intensity', () => {
                it('the intensity on the even elements (layer 1 of 4) decreases from 2/3 to almost 0', () => {
                    const evenIntensities: number[] = evenElements(piece)
                        .map((element: ContourElement<PitchValueIntensityEnvelopeScale>) => use.Ordinal(element, INDEX_OF_GAIN_IN_CONTOUR))
                ...
                it('the intensity on the even elements of the odd elements (layer 2 of 4) increases from 2/3 to 1 then back down to 2/3', () => {
                    const evenOddIntensities: number[] = evenElements(oddElements(piece))
                        .map((element: ContourElement<PitchValueIntensityEnvelopeScale>) => use.Ordinal(element, INDEX_OF_GAIN_IN_CONTOUR))
                ...
                it('the intensity on the even elements of the odd elements of the odd elements (layer 3 of 4) increases from 0 to almost 2/3', () => {
                ...
                it('the intensity on all other elements (odds of the odds of the odds, layer 4 of 4 AKA the non-layer) are at zero', () => {
            ...
            describe('pitch scalar', () => {
                ...
                it('the pitch on all the remaining elements (the odds of the odds of the odds, layer 4 of 4 AKA the non-layer) is at 2^(3/2), the max, though it does not really matter because intensity is at zero, but I guess we think of this is as its final resting pitch having climbed this high haha', () => {
...
so you have to give your value to the element behind you`,
            ...
            describe('pitch scalar - with stretch pitch true', () => {
                ...
                it('the pitch is scaled on all the other elements to 2^(3/2), the max, because thats as high as they reached before going to intensity 0 silence (layer 4 of 4, AKA the non-layer, the evens of the evens of the odds)', () => {
            ...
            describe('intensity', () => {
                it('the intensity on the even elements (layer 1 of 4) increases from 0 to almost 2/3', () => {
                    const evenIntensities: number[] = evenElements(piece)
                        .map((element: ContourElement<PitchValueIntensityEnvelopeScale>) => use.Ordinal(element, INDEX_OF_GAIN_IN_CONTOUR))
                ...
                it('the intensity on the odd elements of the even elements of the odd elements (layer 3 of 4) decreases from 2/3 to almost 0', () => {
                ...
                it('the intensity on all other elements (evens of the evens of the odds, layer 4 of 4 AKA the non-layer) are at zero', () => {
        ...
        describe('when sieve is greater than 2', () => {
            ...
            describe('value', () => {
                it('the value decreases quadratically from 1 to 1/sieve, which is here 1/3', () => {
                    const values: number[] = piece.map(
                        (element: ContourElement<PitchValueIntensityEnvelopeScale>) => use.Ordinal(element, INDEX_OF_DURATION_IN_CONTOUR),
                    )
    ...
    describe('zeno mode', () => {
        ...
        describe('intensity', () => {
            ...
            beforeEach(() => {
                ...
                forEach(piece, (element: ContourElement<PitchValueIntensityEnvelopeScale>, index: Ordinal<ContourPiece<PitchValueIntensityEnvelopeScale>>) => {
            ...
            it('for layer one, they should all stay at full intensity', () => {
...
because there are 1/sieve as many notes happening then - when sieve is 2`,
                () => {
                    ...
                    const values: number[] = piece.map(
                        (kernelElement: ContourElement<PitchValueIntensityEnvelopeScale>) =>
